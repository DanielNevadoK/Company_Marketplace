...
export const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center h-[70vh] w-11/12 rounded-xl bg-[url('/blue_flow_bg.png')] bg-cover px-1 py-0.5 font-semibold">
      ...
      <Button
        effect={"shine"}
        className="bg-[#2384d388] hover:bg-[#2384d3c7] hover:border border-neutral-100 flex items-center justify-center text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
      >
